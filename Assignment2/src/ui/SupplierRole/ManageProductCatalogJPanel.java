...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
    ...
    public void refreshTable() {
        ...
        for (Product p : supplier.getProductCatalog().getProductcatalog()) {
            ...
            row[3] =p.getCity();
            row[4]=p.getSeats();
            row[5]=p.getSerialnumber();
            row[6]=p.getManufacturingyear();
            row[7]=p.getMaintenancedate();
            row[8]=p.getAvailability();
    ...
    private void initComponents() {
        ...
        tblProductCatalog.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product Name", "Product ID", "Price", "City", "Seats", "Serial Number", "Manufacturing year", "Maintenance date", "Availability"
            }
        ));
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        ViewProductDetailJPanel2 vpdjp = new ViewProductDetailJPanel2(userProcessContainer, p);
        userProcessContainer.add("ViewProductDetailJPanel2", vpdjp);
