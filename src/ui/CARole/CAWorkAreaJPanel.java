...
import business.Enterprize.DrugEnterprize;
 ...
 */
public class CAWorkAreaJPanel extends javax.swing.JPanel {

    private JPanel workArea;
    private DrugEnterprize enterprize;
    private Business business;
    private UserAccount userAccount;
    /**
     * Creates new form DoctorWorkAreaJPanel
     */
    public CAWorkAreaJPanel(JPanel workArea, UserAccount account, DrugEnterprize enterprize, Business business) {
        initComponents();
    ...
    public CAWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Drugrole enterprize, Business business) {
    ...
    public void populateRequestTable(){
        ...
        for (WorkRequest request : userAccount.getWorkQueue().getWorkRequestList()){
            ...
            String result = ((LabTestWorkRequest12) request).getTestResult();
    ...
    private void btnRequestTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestTestActionPerformed
        ...
        workArea.add("RequestLabTestJPanel1", new RequestLabTestJPanel1(workArea, userAccount, business));
