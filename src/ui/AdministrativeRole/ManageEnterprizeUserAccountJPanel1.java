 ...
 */
public class ManageEnterprizeUserAccountJPanel1 extends javax.swing.JPanel {
    ...
    public ManageEnterprizeUserAccountJPanel1(JPanel container, Business business) {
        initComponents();
        this.business = business;
        this.container = container;

        popEnterprizeComboBox();
        
        Enterprize enterprize = (Enterprize) cmbEnterprize.getSelectedItem();
        if (enterprize != null) {
            populateEmployeeComboBox(enterprize);
            populateRoleComboBox(enterprize);
        }

        popUserAccountsTable();
    }

    public void popEnterprizeComboBox() {
        cmbEnterprize.removeAllItems();

        for (Enterprize enterprize : business.getenterprizeDirectory().getenterprizeList()) {
            cmbEnterprize.addItem(enterprize);
        }
    }

    public void populateEmployeeComboBox(Enterprize enterprize) {
    ...
    private void populateRoleComboBox(Enterprize enterprize) {
        cmbRoles.removeAllItems();
        for (Role role : enterprize.getSupportedRole()) {
    ...
    private void initComponents() {
        ...
        cmbEnterprize.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbEnterprizeActionPerformed(evt);
            }
        });
                ...
                .addGroup(grpNewUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(grpNewUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(grpNewUserLayout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(cmbEnterprize, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(grpNewUserLayout.createSequentialGroup()
        ...
        grpNewUserLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, grpNewUserLayout.createSequentialGroup()
                ...
                .addGroup(grpNewUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblOrganization)
                    .addComponent(cmbEnterprize, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnCreateUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateUserActionPerformed
        ...
        enterprize.getUserAccountDirectory().createUserAccount(userName, password, employee, role);
    ...
    private void cmbEnterprizeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbEnterprizeActionPerformed
        Enterprize enterprize = (Enterprize) cmbEnterprize.getSelectedItem();
        if (enterprize != null) {
            populateEmployeeComboBox(enterprize);
            populateRoleComboBox(enterprize);
        }
    }//GEN-LAST:event_cmbEnterprizeActionPerformed
