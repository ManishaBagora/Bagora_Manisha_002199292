 ...
 */
public class BostonWorkAreaJPanel extends javax.swing.JPanel {

    private JPanel workArea;
    private HealthEnterprize enterprize;
    private Business business;
    private UserAccount userAccount;
    /**
     * Creates new form DoctorWorkAreaJPanel
     */
    public BostonWorkAreaJPanel(JPanel workArea, UserAccount account, HealthEnterprize enterprize, Business business) {
        initComponents();
    ...
    public void populateRequestTable(){
        ...
        for (WorkRequest request : userAccount.getWorkQueue().getWorkRequestList()){
            ...
            String result = ((LabTestWorkRequest1) request).getTestResult();
    ...
    private void initComponents() {
        ...
        btnRequestTest.setText("Enter your response");
    ...
    private void btnRequestTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestTestActionPerformed
        ...
        workArea.add("RequestLabTestJPanel", new RequestLabTestJPanel1(workArea, userAccount, business));
