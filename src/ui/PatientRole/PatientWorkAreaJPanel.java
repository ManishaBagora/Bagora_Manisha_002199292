...
public class PatientWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public PatientWorkAreaJPanel(JPanel workArea, UserAccount account, PatientOrganization organization, Business business) {
        initComponents();
    ...
    public void populateRequestTable(){
        ...
        for (WorkRequest request : userAccount.getWorkQueue().getWorkRequestList()){
            ...
            String result = ((PatientTestWorkRequest) request).getTestResult();
    ...
    private void initComponents() {
        ...
        btnRequestTest.setText("Request Appointment");
    ...
    private void btnRequestTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestTestActionPerformed
        ...
        workArea.add("RequestPatientTestJanel", new RequestPatientTestJanel(workArea, userAccount, business));
