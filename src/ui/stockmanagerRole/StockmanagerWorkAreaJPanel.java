 ...
 */
public class StockmanagerWorkAreaJPanel extends javax.swing.JPanel {

    private JPanel workArea;
    private StockManagerOrganization organization;
    private Business business;
    private UserAccount userAccount;
    /**
     * Creates new form DoctorWorkAreaJPanel
     */
    public StockmanagerWorkAreaJPanel(JPanel workArea, UserAccount account, StockManagerOrganization organization, Business business) {
        initComponents();
    ...
    public void populateRequestTable(){
        ...
        for (WorkRequest request : userAccount.getWorkQueue().getWorkRequestList()){
            ...
            String result = ((StockmanagerTestWorkRequest) request).getTestResult();
    ...
    private void initComponents() {
        ...
        tblWorkRequests.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Inventory", "Recipient", "Status", "Result"
            }
        ) {
        ...
        btnRequestTest.setText("Request Inventory");
        ...
        lblTitle.setText("Stock Manager Work Area");
    ...
    private void btnRequestTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestTestActionPerformed
        ...
        workArea.add("RequestStockManagerTestJPanel", new RequestStockManagerTestJPanel(workArea, userAccount, business));
