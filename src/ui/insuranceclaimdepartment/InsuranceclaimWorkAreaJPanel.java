...
public class InsuranceclaimWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public InsuranceclaimWorkAreaJPanel(JPanel workArea, UserAccount account, InsuranceclaimOrganization organization, Business business) {
        initComponents();
    ...
    public void populateRequestTable(){
        ...
        for (WorkRequest request : userAccount.getWorkQueue().getWorkRequestList()){
            ...
            String result = ((InsuranceandclaimTestWorkRequest) request).getTestResult();
    ...
    private void initComponents() {
        ...
        tblWorkRequests.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Medicine", "Recipient", "Status", "Result"
            }
        ) {
        ...
        btnRequestTest.setText("Request Claim");
        ...
        lblTitle.setText("Insurance Claim Work Area");
    ...
    private void btnRequestTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestTestActionPerformed
        ...
        workArea.add("RequestinsuranceclaimTestJPanel", new RequestinsuranceclaimTestJPanel(workArea, userAccount, business));
