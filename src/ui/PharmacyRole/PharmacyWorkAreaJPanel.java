...
public class PharmacyWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public PharmacyWorkAreaJPanel(JPanel workArea, UserAccount account, PharmacyOrganization organization, Business business) {
        initComponents();
    ...
    public void populateRequestTable(){
        ...
        for (WorkRequest request : userAccount.getWorkQueue().getWorkRequestList()){
            ...
            String result = ((PharmacyTestWorkRequest1) request).getTestResult();
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Pharmacy Work Area");
    ...
    private void btnRequestTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestTestActionPerformed
        ...
        workArea.add("RequestPharmacyTestJPanel", new RequestPharmacyTestJPanel(workArea, userAccount, business));
