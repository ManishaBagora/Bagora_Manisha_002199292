 ...
 */
public class RequestPharmacyTestJPanel extends javax.swing.JPanel {
     ...
     */
    public RequestPharmacyTestJPanel(JPanel userProcessContainer, UserAccount account, Business business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnRequestTest.setText("Order Now");
        ...
        lblMessage.setText("Please write Medicine name:");
        ...
        lblTitle.setText("Send Medincine Request");
    ...
    private void btnRequestTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestTestActionPerformed
        ...
        PharmacyTestWorkRequest1 request = new PharmacyTestWorkRequest1();
        ...
        for (Organization organization : business.getOrganizationDirectory().getOrganizationList()){
            if (organization instanceof MROrganization){
                org = organization;
                break;
            }
        }
