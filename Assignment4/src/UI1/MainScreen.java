...
public class MainScreen extends javax.swing.JPanel {
     ...
     */
    public MainScreen(JPanel mainWorkArea, UserAccount userAccount, Community community, Business business){
        initComponents();
    ...
    private void initUserWorkArea() {
        ...
        workArea.add("workArea", userAccount.getRole().createWorkArea(workArea, userAccount, community, business));
